...
-- Fallbacks for terminals that send <BS>/<NL> instead of <C-h>/<C-j>
vim.keymap.set('n', '<BS>', '<C-w>h', { desc = 'Move focus to the left window' })
vim.keymap.set('n', '<NL>', '<C-w>j', { desc = 'Move focus to the lower window' })
